package org.operaton.community.process_test_coverage.junit4.platform7.rules;
...
public class TestCoverageProcessEngineRuleBuilder {
     ...
     * <code>-Dorg.operaton.community.process_test_coverage.ASSERT_AT_LEAST=1.0</code>
     */
    public static final String DEFAULT_ASSERT_AT_LEAST_PROPERTY = "org.operaton.community.process_test_coverage.ASSERT_AT_LEAST";
     ...
     */
    public org.operaton.community.process_test_coverage.junit4.platform7.rules.TestCoverageProcessEngineRule build() {
        return this.rule;
    }
}
