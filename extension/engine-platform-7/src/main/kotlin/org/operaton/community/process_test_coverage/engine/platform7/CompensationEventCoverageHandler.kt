...
class CompensationEventCoverageHandler : CompensationEventHandler() {
    ...
    override fun handleEvent(
        eventSubscription: EventSubscriptionEntity, payload: Any?, localPayload: Any?, payloadToTriggerScope: Any?,
        businessKey: String?, commandContext: CommandContext
    ) {
        addCompensationEventCoverage(eventSubscription)
        super.handleEvent(eventSubscription, payload, localPayload, payloadToTriggerScope, businessKey, commandContext)
    }
